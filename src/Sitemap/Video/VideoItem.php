...
class VideoItem extends ItemBase
{
     ...
     *
     * @param  VideoRestriction $restriction
     * @return void
     */
    public function setRestriction(VideoRestriction $restriction)
    {
     ...
     * Set the platform.
     *
     * @param  VideoPlatform $platform
     * @return void
     */
    public function setPlatform(VideoPlatform$platform)
    {
