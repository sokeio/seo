...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
    @if ($__hasImages) xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" @endif
    @if ($__hasVideos) xmlns:video="http://www.google.com/schemas/sitemap-video/1.1" @endif
    @if ($__isMultilingual) xmlns:xhtml="http://www.w3.org/1999/xhtml" @endif>
